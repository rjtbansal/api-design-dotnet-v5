...
| `helmet`, `cors`, `morgan` middleware | `UseHttpsRedirection`, `UseCors`, built-in `ILogger` request logging | Registered in `Program.cs` the same way Express registers middleware before mounting routes |
